...
def main() -> None:
    ...
    write_csv(args.output_dir / "salt_centrality.csv", centrality, fieldnames(centrality))
    write_csv(args.output_dir / "salt_removal.csv", removal, fieldnames(removal))
    write_csv(args.output_dir / "salt_commodity_removal_comparison.csv", removal_comparison, fieldnames(removal_comparison))
    write_csv(args.output_dir / "salt_random_commodity_removal_null.csv", random_removal, fieldnames(random_removal))
    write_csv(args.output_dir / "salt_all_node_removal_baseline.csv", all_node_removal, fieldnames(all_node_removal))
    write_csv(args.output_dir / "salt_label_permutation.csv", label_null, fieldnames(label_null))
    write_csv(args.output_dir / "salt_label_permutation_summary.csv", label_summary, fieldnames(label_summary))
    write_csv(args.output_dir / "salt_community_stability.csv", community_runs, fieldnames(community_runs))
    write_csv(args.output_dir / "salt_community_summary.csv", community_summary, fieldnames(community_summary))
    write_csv(args.output_dir / "salt_source_drop_centrality.csv", source_rows, fieldnames(source_rows))
    write_csv(args.output_dir / "salt_edge_evidence.csv", salt_edges, fieldnames(salt_edges))
    write_csv(args.output_dir / "salt_source_summary.csv", salt_sources, fieldnames(salt_sources))
    write_csv(args.output_dir / "salt_community_members.csv", salt_members, fieldnames(salt_members))
    write_csv(args.output_dir / "salt_brokerage_paths.csv", salt_paths, fieldnames(salt_paths))
    write_csv(args.output_dir / "salt_brokerage_path_summary.csv", salt_path_summary, fieldnames(salt_path_summary))
